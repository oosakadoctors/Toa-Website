...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "大阪の結婚相談所なら［大阪梅田ドクターズ結婚相談所］が選ばれる6つの理由",
    description: "大阪で成婚率が高いおすすめの仲人型結婚相談所なら大阪梅田ドクターズ。現役女医監修のベストを目指す婚活プロデュースとキャリア20年のベテランによる2名1組ダブルサポート、オーダーメイドの婚活戦略でスピード成婚へお手伝いします。",
    url: "/why-us",
...
export default function ReasonsPage() {
  return (
    <div className="bg-[#FAF8F5] text-gray-950 min-h-screen pb-20 selection:bg-pink-500/20 text-[1.25rem] leading-relaxed">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16 pt-16 pb-12 text-center">
        <div className="inline-flex items-center gap-2 bg-rose-500/10 text-rose-500 px-5 py-2.5 rounded-full font-black tracking-widest uppercase mb-6">
          ...
          <span className="text-[0.7rem] sm:text-[0.8rem]">Why Choose Us</span>
        </div>
        <h1 className="text-[2rem] sm:text-[2.5rem] lg:text-[3rem] font-black text-gray-900 leading-[1.3] tracking-tight w-full">
          大阪の結婚相談所なら<span className="text-rose-500"> <br/>［大阪梅田ドクターズ結婚相談所］</span>が選ばれる6つの<br/>理由
          <span className="block text-[0.9em] sm:text-[1.1em] font-bold text-gray-500 mt-4 tracking-normal">
            現役医師監修 × 仲人歴20年ベテランがもたらすロジカル成婚戦略
          </span>
        </h1>

        <h2 className="text-[0.9em] sm:text-[1em] font-medium text-gray-700 max-w-5xl mx-auto mt-6 leading-relaxed">
          大阪で成婚率が高いおすすめの仲人型結婚相談所をお探しの男女へ。大阪梅田ドクターズ結婚相談所が選ばれる理由をご案内します。当相談所では、現役医師（女医）監修によるベストを目指す婚活プロデュースと、キャリア20年のベテラン仲人による2名1組の個別ダブルサポート体制を確立。妥協なき「理想像の徹底解剖」と「男のプライド」「女性のこだわり」を120%受け止めるオーダーメイドの婚活戦略で、ハイクラスな出会いからスピード成婚をめざします。
        </h2>
      ...
      <section className="w-full bg-slate-50 py-12 px-3 sm:px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-8">
            <span className="text-[0.8em] font-black text-rose-500 uppercase tracking-widest block">
              Features
            </span>
            <h2 className="text-[1.2em] sm:text-[1.5em] font-black text-slate-900 leading-relaxed">
              大阪梅田ドクターズ結婚相談所が選ばれる理由
            </h2>
            <p className="text-[0.8em] text-slate-500 mt-2">
              ボックスをタップすると詳細へ移動します
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-5">
            ...
            >
              <div className="flex items-center justify-between w-full mb-2 sm:mb-3">
                <span className="text-[0.65em] sm:text-[0.75em] font-black text-rose-500 bg-rose-50 px-2 py-0.5 sm:px-2.5 sm:py-1 rounded">
                  01
                </span>
              ...
              <span className="text-[0.8em] sm:text-[0.9em] font-bold text-slate-900 group-hover:text-rose-500 transition-colors leading-snug">
                現役女医× ベテランカウンセラー「ベストを目指す婚活プロデュース」
              </span>
              <div className="mt-3 sm:mt-4 flex items-center justify-end text-rose-500 text-[0.65em] sm:text-[0.75em] font-bold gap-1 opacity-70 group-hover:opacity-100 transition-opacity">
                <span>詳細をみる</span>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16 space-y-12 mt-12">
        ...
        <section id="strength1" className="scroll-mt-24 relative w-full">
          <div className="flex items-center gap-4 mb-6">
            ...
            <h2 className="text-[1.2em] sm:text-[1.5em] lg:text-[1.8em] font-black text-gray-900 tracking-tight">
          ...
          <div className="space-y-4 text-gray-800 leading-relaxed font-medium w-full text-[1em]">
            <p className="text-[1em] font-black text-rose-600 bg-white p-5 rounded-2xl border-l-4 border-rose-500 shadow-sm">
            ...
            <p>
              この、医療界と婚活界のトッププロ2名がタッグを組み、会員様1名に対して「男女2人1組の専任チーム」として密着サポートする、稀少なプレミアム相談所です。
            </p>
          </div>
        </section>
          ...
          <div className="w-full max-w-4xl mx-auto my-8">
            <div className="relative w-full aspect-[1/1] overflow-hidden rounded-2xl shadow-md">
              <Image
                ...
                blurDataURL="data:image/jpeg;base64,/9j/4AAQSkZJRgABAQAAAQABAAD/2wBDAP//////////////////////////////////////////////////////////////////////////////////////wgALCAAEAAQBAREA/8QAFBABAAAAAAAAAAAAAAAAAAAAAP/aAAgBAQABPxA="
              />
              <p className="absolute bottom-2 right-2 z-10 text-[0.6em] text-slate-500 bg-white/80 px-2 py-0.5 rounded pointer-events-none select-none">
                ※画像はイメージです。
              </p>
            </div>
          </div>

          <div className="space-y-2 text-gray-800 leading-relaxed font-medium w-full text-[1em]">
            <p className="text-[1em] font-black text-rose-600 bg-white p-5 rounded-2xl border-l-4 border-rose-500 shadow-sm">
              現役医師の心理分析 × 20年の成婚データで、あなたの「本当の結婚相手」をさがすお手伝いをします。
            </p>
            <p>
              当相談所が他とは少しちがう理由は、現役医師とカウンセラー歴20年のベテラン男性仲人が「2名1組のチーム」となり、あなた専用の婚活セカンド（セコンド）として徹底的に伴走する点にあります。
            </p>
            <p>
            ...
            <p>
              そこに、20年間関西圏のシビアな婚活市場（大阪市・堺市・東大阪市・枚方市・吹田市・豊中市・八尾市など）を見続けてきたプロの豊富な成婚データを掛け合わせることで、あなたのライフスタイルや性格に100%マッチする「隠れた優良男性・理想の女性」の条件をさがすお手伝いをします。高収入・高学歴・正社員・公務員・経営者など、身元が保証された年収600万円以上のハイクラスな会員層からも、あなたに本当に合うお相手をスクリーニングします。
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8 pt-6 border-t border-gray-200">
              ...
              <div className="w-full space-y-3 rounded-2xl border border-rose-100 bg-rose-50 p-6 text-gray-800 leading-relaxed font-medium shadow-sm">
                <span className="inline-block text-[0.7em] font-black bg-rose-500 text-white px-3 py-1 rounded mb-2">
                  現役女医の視点
                </span>
                <div className="text-[0.90em] leading-relaxed text-gray-700">
        ...
        <section id="03" className="w-full">
          ...
          <div className="space-y-4 text-gray-800 leading-relaxed font-medium w-full text-[1em]">
            ...
            <p>
              婚活において「理想をあきらめたくない」というアラサー・アラフォー女性の切実な願いや、「自分の男のプライドを傷つけられたくない」「会社の同僚や友人にバレたくない」という20代・30代・40代のビジネスパーソンの男の本音を、私たちは決して否定しません。
            </p>
            <p className="font-bold text-gray-900">
              客観的なデータ分析（ロジカルな戦略）と、1対1の手厚いサポート（感情に寄り添う親身なケア）をうまく両立させることができます。
            </p>
            <p>
              恋愛経験なしの方や口下手な男性であっても、2名のプロがお見合い会話術の伝授から梅田・難波での服装コーディネート（ショッピング同行）、さらには交際中のLINEの返信頻度や、仮交際お断りの理由分析、真剣交際タイミングの調整、さらにはプロポーズの言葉・シチュエーションの演出までをサポートします。
            </p>
            <p className="text-[1em] text-gray-800 border-t border-gray-200 pt-6">
              自己流の婚活やマッチングアプリの不都合な真実（サクラ・嘘・目的違い）に振り回されて婚活疲れを起こす前に、ベストを目指すプロフェッショナルによる妥協なき「理想像の徹底解剖」をぜひご体感ください。あなたのプライドを守りがら、最短の成婚をめざすシステムがここにあります。
            </p>
          </div>
        </section>
          ...
          <div className="space-y-4 text-gray-800 leading-relaxed font-medium w-full text-[1em]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 py-4">
              <div className="border border-gray-200 rounded-2xl p-6 bg-white shadow-sm">
                <p className="font-black text-[0.9em] text-gray-900 mb-2">データ主導マッチング</p>
                <p className="text-[0.8em] text-gray-600">「感覚」に頼らず、お互いが相思相愛になりやすいハイクラスなお相手を厳選します。</p>
              </div>
              <div className="border border-gray-200 rounded-2xl p-6 bg-white shadow-sm">
                <p className="font-black text-[0.9em] text-gray-900 mb-2">抜群のタイムパフォーマンス</p>
                <p className="text-[0.8em] text-gray-600">仕事と両立できるよう無駄な時間を省き、スタイリッシュに進め、最短期間での成婚を目指します。</p>
              </div>
              <div className="border border-gray-200 rounded-2xl p-6 bg-white shadow-sm">
                <p className="font-black text-[0.9em] text-gray-900 mb-2">キャリアへの深い理解</p>
                <p className="text-[0.8em] text-gray-600">共働きや、互いの専門的なライフスタイルを心から尊敬し合える理想のパートナーを探すお手伝いをします。</p>
              </div>
            </div>

            <div className="space-y-4 bg-rose-50/50 border border-rose-100 rounded-2xl p-2">
              <h3 className="text-[1.2em] sm:text-[1.5em] lg:text-[1.8em] font-black text-gray-900 pt-2 flex items-center gap-3">
                <LineChart className="w-7 h-7 text-rose-500" />
                成婚の確率を高める「3つの医療アプローチ」
              </h3>
              <div className="flex gap-4 items-start pt-2">
                <span className="font-black text-[0.65em] sm:text-[0.7em] text-rose-600 bg-rose-100 px-3 py-1 rounded h-6 shrink-0">1. 検査</span>
              ...
              <div className="flex gap-4 items-start border-t border-rose-100/50 pt-4">
                <span className="font-black text-[0.65em] sm:text-[0.7em] text-rose-600 bg-rose-100 px-3 py-1 rounded h-6 shrink-0">2. 処方</span>
                <p className="text-[1em] text-gray-800">
              ...
              <div className="flex gap-4 items-start border-t border-rose-100/50 pt-4">
                <span className="font-black text-[0.65em] sm:text-[0.7em] text-rose-600 bg-rose-100 px-3 py-1 rounded h-6 shrink-0">3. サポート</span>
                <p className="text-[1em] text-gray-800">
            ...
            <div className="pt-4">
              <div className="space-y-4 bg-rose-50/50 border border-rose-100 rounded-2xl p-8">
                <h4 className="text-[1.2em] sm:text-[1.5em] lg:text-[1.8em] font-black text-gray-900 text-center mb-4">
                  【仕事も結婚も両方欲しい！】
                </h4>
                <p className="text-[1em] text-gray-800 leading-relaxed">
        ...
        <section id="05" className="w-full">
          ...
          <div className="space-y-4 text-gray-800 leading-relaxed font-medium w-full text-[1em]">
            ...
            <div className="bg-rose-50/50 border border-rose-100 rounded-2xl p-8 my-4">
              <h3 className="text-[1.2em] sm:text-[1.5em] lg:text-[1.8em] font-black text-gray-900 flex items-center gap-3 mb-4 pt-2">
                <Brain className="w-7 h-7 text-rose-500 shrink-0" />
                医学・心理学的アプローチによる「独自のメンタルケア体制」
              </h3>
              
              <p className="text-[1em] text-gray-800 leading-relaxed">
                当相談所は、医療現場で多くの心と向き合ってきた現役医師が監修し、自らもカウンセラーを兼任する、大阪でも珍しい体制を整えています。医学的・心理学的知見に基づいた独自の「婚活メンタルケア」を導入し、感情論ではないロジカルなアプローチを実施。お断りの理由を客観的に分析して次の出会いに繋げ、婚活疲れにならないようにお手伝いします。
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="06" className="w-full">
          ...
          「これまでの人生で異性と付き合ったことがない」「人見知りで、お見合いや初デートで気まずい沈黙にならないか不安」という恋愛経験なしの方も、どうぞ安心してお任せください。
            当相談所には、20年間にわたり大阪のシビアな婚活市場を経験し、数多くの口下手な男女をスピード成婚へ導いてきたベテラン男性仲人が在籍しています。
            異性受けするプロフィール写真の撮り方から、梅田・難波でのデートにふさわしい服装のコーディネート、女性心理・男性心理を掴むお見合い会話術、嫌われないLINEの頻度まで、まるで塾の先生のようにマンツーマンで丁寧に指導。自己流の恋愛ではなく、20年の成婚データに基づく必勝テクニックを伝授し、あなたの魅力をあげるお手伝いをします。            </p>
