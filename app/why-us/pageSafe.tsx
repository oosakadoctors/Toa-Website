  ...
  return (
    <div className="bg-[#FAF8F5] text-gray-950 min-h-screen pb-16 selection:bg-[#E6A2B3]/20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16 pt-12 pb-10 text-center">
        ...
        <h2>  大阪で成婚率が高いおすすめの仲人型結婚相談所をお探しの男女へ。大阪梅田ドクターズ結婚相談所が選ばれる理由をご案内します。当相談所では、現役医師（女医）監修によるベストを目指す婚活プロデュースと、キャリア20年のベテラン仲人による2名1組の個別ダブルサポート体制を確立。妥協なき「理想像の徹底解剖」と「男のプライド」「女性のこだわり」を120%受け止めるオーダーメイドの婚活戦略で、ハイクラスな出会いからスピード成婚までを最短距離で実現します。</h2>
...
<section id="02" className="w-full">
  ...
  <div className="space-y-2 text-gray-800 leading-relaxed font-medium w-full">
    ...
    <p>
      当相談所では、まずあなた自身が気づいていない深層心理にある「本当の結婚相手への理想像」を入会面談で徹底的に解剖します。医師監修のカウンセリング心理学や脳科学、行動経済学のアプローチを用いて、あなたが人生において<span className="text-purple-700 font-bold">「譲れない条件」</span>と<span className="text-gray-500 font-bold">「実は妥協しても幸せになれるポイント」</span>をロジカルに切り分けます。
    </p>
    <p>
 ...
 <section id="03" className="w-full">
  ...
  <div className="space-y-2 text-gray-800 leading-relaxed font-medium w-full">
    ...
    <p className="text-base text-gray-800 border-t border-gray-200 pt-6">
      自己流の婚活やマッチングアプリの不都合な真実（サクラ・嘘・目的違い）に振り回されて婚活疲れを起こす前に、ベストを目指すプロフェッショナルによる妥協なき「理想像の徹底解剖」をぜひご体感ください。あなたのプライドを守りながら、最短ルートでスピード成婚へ導くシステムがここにあります。
    </p>
  </div>
</section>
...
<section id="05" className="w-full">
  ...
  <div className="flex items-center gap-4 mb-6">
    ...
    <h2 className="text-xl sm:text-2xl lg:text-3xl font-black text-gray-900 tracking-tight">
      【現役医師監修】心理学・脳科学に基づく「心が疲れない婚活」を目指してサポートします
    </h2>
  </div>
  ...
  <div className="space-y-2 text-gray-800 leading-relaxed font-medium w-full">
    ...
    <div className="bg-rose-50/50 border border-rose-100 rounded-2xl p-6 my-2">
      ...
      <p className="text-base sm:text-lg text-gray-800 leading-relaxed">
        当相談所は、医療現場で多くの心と向き合ってきた現役医師が監修し、自らもカウンセラーを兼任する、大阪でも珍しい体制を整えています。医学的・心理学的知見に基づいた独自の「婚活メンタルケア」を導入し、感情論ではないロジカルなアプローチを実施。お断りの理由を客観的に分析して次の出会いに繋げるため、婚活疲れの解消を目指します。
      </p>
    </div>
  </div>
</section>
