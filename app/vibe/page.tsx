            ...
            <div className="bg-white p-6 md:p-8 border-2 border-sky-200 rounded-2xl shadow-md space-y-4 text-[20px] md:text-base text-slate-700 leading-relaxed font-medium">
              ...
              <div className="bg-sky-50 border-l-4 border-sky-500 p-4 rounded-r-xl space-y-2 mt-4">
                ...
                <p className="italic text-slate-800">
                  「A子さんは『170cm以上、年収600万円以上』というご希望の条件はしっかりありますが、恋愛経験も少なく、具体的な『理想の男性像』のイメージはまだ少しぼんやりされていますよね。でも、最初から明確なイメージを持てている人なんていませんから、まったく問題ありません！ これから活動を進めながら、私たちと一緒に理想に近いパートナー像をしっかりと固めていきましょうね。」
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white/95 backdrop-blur-md text-slate-800 p-6 md:p-10 rounded-2xl shadow-2xl space-y-6">
              ...
              <div className="space-y-4 text-[20px] md:text-base leading-relaxed">
                <div className="bg-sky-50 p-4 rounded-xl border border-sky-200">
                  ...
                  <p>「なるほど、システムや進め方がすごくよく分かりました！…あの、実はさっき『理想のイメージがぼんやりしている』と言ったんですけど、いろいろお話を聞いていくうちに、自分の中で譲れない深いこだわりがいくつか湧いてきたんです。」</p>
                </div>
                ...
                <div className="bg-sky-50 p-4 rounded-xl border border-sky-200">
                  <span className="font-bold text-sky-800 block mb-1">A子さん：</span>
                  <p>「私、学生時代からずっとテニスが趣味で、今も週末にスクールに通っているんです。だから、結婚してからもできれば趣味を一緒に楽しめるようなアクティブな人がいいなって。それと、今家で猫を飼っているので、動物が好きな人じゃないと一緒に暮らせないなと思って……。」</p>
                  <p className="mt-2">「あと、タバコの煙や匂いが本当に苦手なので、お相手は『タバコを吸わない非喫煙者の人』がいいです。年収や身長も大切ですけど、こういう生活のこだわりって、やっぱりワガママになっちゃいますか？」</p>
                </div>
                ...
                <div className="bg-gradient-to-br from-sky-100 to-blue-100 p-6 rounded-xl border-2 border-sky-300 space-y-3">
                  ...
                  <p>「ワガママなんてとんでもない！今お話ししてくださったことこそ、結婚生活を長く幸せに続けるために、年収や身長以上にめちゃくちゃ重要な『理想に近いヒント』ですよ！」</p>
