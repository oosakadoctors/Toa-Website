...
export const metadata: Metadata = {
  ...
  alternates: {
  canonical: "/smart-dating",
},
  description: '大阪梅田ドクターズ結婚相談所による仮交際初デートの相談実例。33歳・初婚のプログラマー男性（恋愛初心者／年収500万円）の事例をもとに、お見合い後のカジュアル服・トートバッグ・靴の選定（写メ確認）、手土産（紅茶パック）を活用した対話術を解説。さらに32歳女性（医療検査技師）へのリスペクト、自分の得意分野の喋りすぎを防ぎ、医学・心理学に基づくEQ向上と安心感を与えることで「1回目で終了しやすい仮交際」を突破するロジカルな成婚戦略を可視化。',
  openGraph: {
    title: '33歳恋愛初心者プログラマー男性の仮交際初デート相談実例',
    description: '大阪梅田ドクターズ結婚相談所による仮交際初デートの相談実例。33歳・初婚のプログラマー男性（恋愛初心者／年収500万円）の事例をもとに、お見合い後のカジュアル服・トートバッグ・靴の選定（写メ確認）、手土産（紅茶パック）を活用した対話術を解説。さらに32歳女性（医療検査技師）へのリスペクト、自分の得意分野の喋りすぎを防ぎ、医学・心理学に基づくEQ向上と安心感を与えることで「1回目で終了しやすい仮交際」を突破するロジカルな成婚戦略を可視化。',
    type: 'website',
...
export default function DateConsultationPage() {
  const tableRows = [
    ...
    },
    {
      ...
      solution: "【医学・心理学に基づくEQ向上】表面的なモテテクを完全排除。自分の話の誇示を抑え、医療検査技師として自立して働く彼女への『リスペクト』と言葉の傾聴に徹し、安心感を提示。"
    },
    {
      category: "自己肯定感・魅力定義",
                ...
                <ul className="space-y-3 list-none p-0">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      女性は男性の足元を驚くほど見ています。綺麗に手入れされたスニーカーか革靴を指定し、ポケットにはアイロンの効いたハンカチとティッシュを用意するよう小物の確認も徹底しました。
                    </div>
                  </li>
                </ul>
              </div>
          ...
          <div className="max-w-5xl mx-auto w-full px-4 md:px-0 space-y-8">
            ...
            <div className="bg-white p-6 md:p-8 border-2 border-sky-200 rounded-2xl shadow-md space-y-6 text-[20px] md:text-base text-slate-700 leading-relaxed font-medium">
              <p>
                ...
                男性の魅力は、派手な華やかさや強引なリードだけではありません。Cさんの持つ「一人暮らしが長く、こだわりが少なくて優しい穏やかさ」や「高い包容力」こそが、結婚生活を前提とした仮交際において、女性が本能的に求める付加価値になります。<br />
              ...
              <p>
                ...
                当日は、コーディネートした服に身を包み、手土産を持ってリラックスして臨んだCさん。お見合い時のスーツ姿に劣らない「誠意と安心感」が彼女の心に深く刺さり、1回目で終了しやすい仮交際の壁を軽々と突破。その後も順調に交際を重ね、彼女の「心の安全基地」として選ばれる存在へとなっていく素晴らしい第一歩を踏み出しました。
              </p>
            </div>
          </div>
        </section>
