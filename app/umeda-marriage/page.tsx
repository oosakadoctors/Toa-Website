  ...
  return (
    <main className="mx-auto max-w-[600px] bg-[#f0f7fc] px-4 py-6 text-[18px] leading-[1.8] text-[#2b3a4a] box-border">
      ...
      <section className="mb-10 text-center">
        ...
        <h1 className="mb-4 text-2xl font-bold leading-[1.4] text-[#1a365d]">大阪梅田ドクターズ結婚相談所は、北新地駅から徒歩1分、大阪駅前第2ビル2階にある結婚相談所です。日本結婚相談所連盟（IBJ）に加盟しています。

いちばんの特徴は、担当カウンセラーが2人つくことです。</h1>
        
        <p className="mb-4 mt-0 text-[18px]">大手のマニュアルにはない、家族のような温もりがここにあります。ご縁のあった会員様を大切な家族のように送り出す気持ちで支えます。小さな不安や疑問も、親身にサポートします。</p>
      ...
      <section className="mb-10 text-center">
        ...
        <h2 className="mb-4 text-[21px] font-bold leading-[1.4] text-[#1a365d]">現役女医×ベテランカウンセラーが伴走<br />｜コースは１つだけ。月会費15,000円（税込）。そのほか入会金・登録料・成婚料がかかります。詳しくは料金ページをご覧ください。</h2>
        
        <p className="mb-4 mt-0 text-[18px] text-left">
          複雑な料金プランは一切ありません。私たちは、婚活を継続していただけるよう、月会費15,000円（税込）の一つのコースにすべての情熱を注いでいます。強みは、現役女医による親身なアドバイスと、ベテランカウンセラーによる細やかなケアを同時に受けられることです。安心と温もりを大切にしています。。
        </p>
      </section>
      ...
      <section className="mb-10 text-center">
        ...
        <p className="mb-4 mt-0 text-[18px] text-left">
          一人ひとりの会員様に寄り添い、満足度、1年以内のご成婚、そして一歩目となるお見合い成立のすべてにおいて　高みを目指しているのが、私たち「大阪梅田ドクターズ結婚相談所」です。現役女医である代表と、20年寄り添い続けてきたベテランがタッグを組み、お一人おひとりの魅力を最大限に引き出す「手作りの温かい婚活サポート」を目指します。確かなお見合い成立へとつなげるプロの特別推薦に加え、活動開始から「1年以内のご成婚」を本気で目指す体制を整えているからこそ、会員様様からお喜びの声をいただいております。
        </p>
