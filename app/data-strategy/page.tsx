...
export const metadata: Metadata = {
  title:
    "データで導き心で繋ぐ「生成AI×仲人の経験知」の成婚戦略｜大阪梅田ドクターズ結婚相談所",
  description:
...
export default function AiStrategyPage() {
  const jsonLd = {
    ...
    headline:
      "データで導き心で繋ぐ「生成AI×仲人の経験知」の成婚戦略｜大阪梅田ドクターズ結婚相談所",
    description:
      "当相談所では、最先端の生成AIを独自のプロンプト戦略でアドバイスの作成に利用。現役女性医師とベテラン仲人が軍師として伴走する、新時代のデータ婚活。",
    publisher: {
      "@type": "Organization",
      name: "大阪梅田ドクターズ結婚相談所",
    },
  ...
  return (
    <main className="relative min-h-screen text-[20px] leading-relaxed text-gray-800 px-1 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-4xl space-y-12">
        ...
        {/* SECTION 2: Concrete AI Applications (4 Pillars) */}
        <section className="space-y-8">
          <div className="bg-sky-900/90 text-white p-6 sm:p-8 rounded-3xl backdrop-blur-md shadow-lg border border-sky-700/50">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black leading-snug text-sky-200">
              具体的にAIをどのような場面で「作成に利用」するのか？
            </h2>
            <p className="mt-2 text-amber-300 text-xl font-bold">
              【答え】AIが選択肢を列挙・提示し、カウンセラーと相談しながら選ぶのはあなたです。
            </p>
          </div>

          <div className="bg-white/95 rounded-3xl border-2 border-sky-300 p-8 sm:p-10 shadow-lg space-y-4 backdrop-blur-sm">
            <h3 className="text-2xl sm:text-3xl lg:text-4xl font-black text-sky-950 leading-snug flex items-center gap-2">
              <span>🎯</span> 理想像の整理（AIが選択肢を提示しあなたが選ぶ）
            </h3>
          ...
          <div className="bg-white/95 rounded-3xl border-2 border-sky-300 p-8 sm:p-10 shadow-lg space-y-4 backdrop-blur-sm">
            <h3 className="text-2xl sm:text-3xl lg:text-4xl font-black text-sky-950 leading-snug flex items-center gap-2">
              <span>📋</span> 住居・金銭感覚・親族関係の確認リスト
            </h3>
            <p className="text-[20px] leading-relaxed">
              理想の結婚像を現実化するために、お相手に確認すべきシビアな内容（具体的な金銭支払い、生活時間のとり方、親族との距離感など）のチェックリストを作成します。
            </p>
          </div>

          <div className="bg-white/95 rounded-3xl border-2 border-sky-300 p-8 sm:p-10 shadow-lg space-y-4 backdrop-blur-sm">
            <h3 className="text-2xl sm:text-3xl lg:text-4xl font-black text-sky-950 leading-snug flex items-center gap-2">
              <span>💬</span> 関係性を深める会話・質問候補の作成
            </h3>
            <p className="text-[20px] leading-relaxed">
              客観的・一般的に好まれる会話選択肢や質問候補を提示します。あくまでも客観的な視点のみのため、あなたの性格やお相手との関係を考慮するのは、カウンセラーとの相談となります。
            </p>
          </div>
        </section>

        {/* SECTION 3: Summary Callout Box & AI vs Human Roles */}
        <section className="bg-amber-50/90 rounded-3xl border-2 p-6 sm:p-10 border-amber-200 shadow-lg space-y-6 backdrop-blur-sm">
          ...
          <div className="bg-white/90 rounded-2xl p-6 sm:p-8 shadow-sm space-y-3">
            <h3 className="font-black text-sky-950 text-xl sm:text-2xl">
              🤖 AIができること
            </h3>
            <p className="text-[20px]">
              データの論理的整理、多角的な選択肢の網羅的な列挙、安全な環境による文章や質問候補の作成。
            </p>
          </div>
          ...
          <div className="bg-white/90 rounded-2xl p-6 sm:p-8 shadow-sm space-y-3">
            ...
            <p className="text-[20px]">
              本質的な結婚価値観（ゼロから1）の言語化、お相手の心理カラーに踏み込んだ交際戦略の決定、愛着関係の育成。
            </p>
          </div>

          <p className="text-[20px] text-gray-800 leading-relaxed pt-2">
            医療界のリアルを知り尽くした【現役女性医師カウンセラー】と、百戦錬磨の【ベテラン男性仲人】が、AIという強力な武器をコピペや丸投げではなく使いこなしながら、あなたという「主役」の横で最高の軍師として最後まで温かく寄り添い続けます。
          </p>
        </section>

        {/* SECTION 4: Security Note */}
        <section className="bg-slate-900/90 text-white rounded-3xl border border-slate-700 p-6 sm:p-8 shadow-lg backdrop-blur-md">
