        ...
        <section className="space-y-8">
          ...
          <div className="rounded-2xl bg-white border border-rose-200 p-6 sm:p-8 shadow-sm space-y-4">
            ...
            <div className="text-[18px] text-gray-700 leading-relaxed space-y-3">
              ...
              <p style={{ wordBreak: 'break-all' }}>
                日本の結婚相談所の連盟には、現在全国で数万人を超える非常に多くの一般の男女が登録しています。一般的な会員背景データとして、年齢層は男女ともに30代前半がボリュームの多い中心層となっています。また、男女比の割合も「男性約4割、女性約6割」とバランスが良く、職業もごく一般的な会社員や公務員、技術職、看護師や保育士など、社会のさまざまな場所で真面目に働いている普通の男女がほとんどです。
              </p>
