      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="bg-white/95 backdrop-blur-md shadow-2xl border border-amber-100 rounded-3xl p-6 sm:p-10">
          ...
          <div className="bg-amber-50/70 p-5 sm:p-6 rounded-2xl border border-amber-200/60 text-[18px] text-slate-700 leading-relaxed mb-8 shadow-2xs space-y-4">
            ...
            <p>
              人間が内側から満たされ、誰にも真似できない穏やかで深い大人のオーラを放っているとき、そこには<strong>「居場所」「目的」「自由」</strong>という3つの本質的な要素が、完璧な三位一体として揃っています。
            </p>
            <p>
          ...
          <div className="space-y-10 text-[18px] text-slate-700 leading-relaxed">
            ...
            <section>
              ...
              <div className="pl-0 sm:pl-11 space-y-4">
                ...
                <p>
                  こうした「小さくてもしたいこと」へ向かって一歩を踏み出して行動している時間そのものが、人間の生命力を高い次元で活性化させます。
                </p>
                <p>
                  より良い自分や未来を目指して進むエネルギーがあるとき、人の眼差しには輝きが宿り、佇まいには知性と洗練された美しさが現れます。魅力の大小を他人と比べる必要など一切ありません。自分の内なる「したい」に純粋に向き合い、そのプロセスをがんばっている瞬間こそが、人間を内側から満たしてくれる幸せの源泉なのです。
                </p>
              </div>
            </section>
        ...
        <div className="bg-white/95 backdrop-blur-md shadow-2xl border border-amber-100 rounded-3xl p-6 sm:p-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-[18px] text-slate-700 space-y-4 leading-relaxed">
              ...
              <p>
                婚活の道のりはしもうまくいく瞬間ばかりではありませんが、その中、自分を見つめて努力した経験は、将来きっとあなたの礎となり、あなたを成長させてくれることと思います。深みある人間に成長し、温かみを持ち、未来を支えてくれることを心から願っています。
              </p>
