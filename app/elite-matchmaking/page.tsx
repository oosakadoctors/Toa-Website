    ...
    <div>
      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto flex flex-col items-center space-y-6">
          ...
          <div className="w-full max-w-3xl rounded-2xl border border-amber-200/70 bg-white/85 backdrop-blur-md p-6 sm:p-8 shadow-sm text-left sm:text-center">
            <p className="text-sm sm:text-base lg:text-lg font-medium text-gray-800 leading-relaxed sm:leading-loose">
      ...
      <section className="mx-auto px-0 sm:px-2 lg:px-10 py-2">
        <div className="rounded-3xl border border-amber-100 bg-white shadow-sm p-6 sm:p-10">
          ...
          <div className="space-y-2 text-gray-800 leading-relaxed font-medium w-full">
            ...
            一方で、責任ある立場になればなるほど、誰からも助言は得られにくく自らで自らの判断や行動を律し、あらゆるフィールドで知的好奇心を満たしながら、さらなる高みを目指す毎日になります。<br/><br/>
          ...
          <div className="space-y-2 text-gray-800 leading-relaxed font-medium w-full">
            ...
            <div className="mt-8 flex justify-center">
              <Link
                ...
                className="group inline-flex items-center justify-center rounded-full bg-amber-500 px-6 py-3 text-base font-bold text-white shadow-md transition-all duration-300 hover:-translate-y-0.5 hover:bg-amber-600 hover:shadow-xl active:translate-y-0"
              >
                結婚すべきか？詳しく見る
                <span className="ml-2 transition-transform duration-300 group-hover:translate-x-1">
                  →
      ...
      <section className="mx-auto px-0 sm:px-2 lg:px-10 py-2">
        <div className="rounded-3xl border border-amber-100 bg-white shadow-sm p-6 sm:p-10 mb-4">
          <h2 className="text-xl sm:text-4xl lg:text-5xl font-black text-gray-900 leading-tight mb-4">
      ...
      <div id="essential-question" className="w-full mb-10 sm:px-4">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="bg-white w-full p-5 sm:p-8 shadow-xs border-y sm:border border-amber-100 sm:rounded-2xl">
            <span className="text-xs sm:text-sm font-black text-amber-600 uppercase tracking-widest block mb-1.5">The Essential Question</span>
            <h2 className="text-xl sm:text-4xl lg:text-5xl font-black text-gray-900 leading-tight">
            ...
            <h3 className="text-lg sm:text-xl font-black text-gray-800 leading-snug mb-4 border-l-4 border-amber-500 pl-3">
            ...
            <div className="space-y-2 text-gray-800 leading-relaxed font-medium w-full">
              ...
              <p className="font-black text-gray-950 text-lg sm:text-xl pt-2 text-amber-700">
                「どちらが正しい」ということはありません。
              </p>
              <p>
            ...
            <div className="space-y-6 mt-4">
              ...
              <div className="bg-[#FFFDF9] p-5 rounded-xl border border-amber-100/60">
                <h4 className="font-black text-lg sm:text-xl text-gray-900 mb-3 flex items-start gap-2">
                  <span className="bg-amber-500 text-white text-xs sm:text-sm font-black px-2.5 py-0.5 rounded-sm shrink-0 mt-1">1</span>
                  人生の「基盤・よりどころ」としての位置づけと孤独の解消
                </h4>
                <p className="space-y-2 text-gray-800 leading-relaxed font-medium w-full">
                  最も多くの人が家族に求める位置づけです。結婚を「人生を生き抜くためのチーム結成」と捉えます。具体的には絶対的な味方がいることで安心や安定を得られます。
                </p>
                <div className="mt-3 space-y-2 pl-3 border-l-2 border-amber-400 text-sm sm:text-base text-gray-600">
              ...
              <div className="bg-[#FFFDF9] p-5 rounded-xl border border-amber-100/60">
                <h4 className="font-black text-lg sm:text-xl text-gray-900 mb-3 flex items-start gap-2">
                  <span className="bg-amber-500 text-white text-xs sm:text-sm font-black px-2.5 py-0.5 rounded-sm shrink-0 mt-1">2</span>
              ...
              <div className="bg-[#FFFDF9] p-5 rounded-xl border border-amber-100/60">
                <h4 className="font-black text-lg sm:text-xl text-gray-900 mb-3 flex items-start gap-2">
                  <span className="bg-amber-500 text-white text-xs sm:text-sm font-black px-2.5 py-0.5 rounded-sm shrink-0 mt-1">3</span>
          ...
          <div className="bg-white w-full p-5 sm:p-8 shadow-xs border-y sm:border border-amber-100 sm:rounded-2xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-5">
              <div className="bg-[#FFFDF9] p-4 sm:p-5 rounded-xl border border-amber-100/60">
                <p className="font-black text-base sm:text-lg mb-2 flex items-center gap-1.5 text-amber-700">
          ...
          <div className="bg-gradient-to-b from-white to-[#FFFDF9] w-full p-5 sm:p-8 shadow-sm border-y sm:border border-amber-200/50 sm:rounded-3xl">
            <div className="flex items-center gap-2 mb-5">
              <span className="bg-amber-100 text-amber-800 text-xs sm:text-sm font-black px-3 py-1 rounded-md tracking-wider">
                女医からの一言
              </span>
            </div>
            ...
            <div className="text-gray-800 leading-relaxed font-medium">
              ...
              <p className="font-black text-gray-950 text-lg sm:text-xl border-l-4 border-amber-500 pl-4 py-3 bg-white shadow-sm rounded-r-xl border border-amber-100 mb-4">
