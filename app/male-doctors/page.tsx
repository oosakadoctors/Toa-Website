...
<section className="bg-gradient-to-br from-slate-900 via-sky-950 to-blue-900 text-white rounded-3xl p-8 sm:p-12 shadow-xl space-y-8 border border-sky-700/50 overflow-hidden">
  ...
  <div className="-mx-8 -mb-8 sm:-mx-12 sm:-mb-12 p-8 sm:p-12 bg-white text-gray-900 rounded-b-3xl mt-8">
    ...
    <p className="text-gray-800 text-[20px] leading-relaxed">
      ...
      現代の婚活において、男性医師が「同じ目線で語り合える女医」を人生の伴侶に選ぶのは、合理的で前向きな決断です。<br />
      真に魅力的なハイスペック男女は、不特定多数が集まるアプリやカジュアルなパーティーには現れません。お互いの時間価値を理解し、プライバシーが完全に守られた特別な環境にこそ、理想の出会いは存在します。<br />
      「大阪梅田ドクターズ結婚相談所」は、医師同士・医療従事者同士の出会いをサポートする、プライバシーに配慮した環境です。お互いの背景を1秒で理解し合える高い親和性をもって、生涯の伴侶であり、ビジネスパートナーとなるお相手を探すお手伝いをします。
    </p>
...
<section className="bg-rose-50/70 rounded-3xl border-2 border-rose-300 p-4 sm:p-4 shadow-sm space-y-6">
  ...
  <div className="text-gray-800 text-[20px] leading-relaxed">
    ...
    <p className="mb-5">
      医師は体が資本の職業ですから、いざ万が一というときに、自分を支えてくれるパートナーの存在は心強いものとなります。大阪梅田ドクターズ結婚相談所では、女性として魅力的だなと思うような恋愛の要素だけではなく、どんなお相手となら理想の家庭生活、未来が描けるのかを人生の先輩としてご相談させていただきます。ご両親のご意見も、あなたの選択に価値ある助言であることも多いです。
    </p>
        ...
        <section className="space-y-8">
          <div className="bg-white rounded-3xl border-2 border-sky-300 p-8 sm:p-10 shadow-sm space-y-4">
            ...
            <p className="text-[20px]">
              将来を見据え、同じ医師としてのビジョンを持つ女性との結婚を希望する男性医師が今、非常に増えています。世帯年収の安定はもちろん、次世代への教育方針の共有、さらにはクリニックの開業や共同経営において、同じレベルのリテラシーで未来をデザインできる他には少ない存在です。大阪梅田ドクターズ結婚相談所は、このハイスペック同士のシナジーを最大化する独自のネットワークを構築しています。
            </p>
          </div>
          ...
          <div className="bg-white rounded-3xl border-2 border-sky-300 p-8 sm:p-10 shadow-sm space-y-4">
            ...
            <p className="text-[20px]">
              当直やオンコール、急な手術や論文執筆など、医療の最前線に立つあなたのライフスタイルを、当相談所の女医カウンセラーは、説明せずとも理解できます。過度な説明や遠慮は一切不要です。限られた時間の中で、お互いの仕事を深く尊重し合いながら、スマートに交際を進めることができます。
            </p>
          </div>
  ...
  />
          ...
          <div className="space-y-6">
            ...
            <p className="text-[20px]">
              当相談所は、会員数を極少数に限定した完全会員制です。お一人おひとりの状況に合わせて、あなたの婚活を緻密かつ迅速にプロデュースします。
            </p>
            ...
            <div className="bg-sky-50/80 rounded-2xl p-6 sm:p-8 border border-sky-200 space-y-3">
              ...
              <p className="text-[20px]">
                ...
                婚活において重要なのは「何事も迅速に方向性を決定すること」。そしてその決定に基づいた「具体的な行動戦略（アクションプラン）」の策定です。PDCAサイクルを高速で回し、最短期間での成婚を目指します。
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-3xl border-2 border-sky-300 p-8 sm:p-10 shadow-sm space-y-6">
          ...
          <p className="text-[20px] space-y-4">
            ...
            これにより、梅田周辺の関西エリアはもちろん、全国の厳選されたハイスペック男女「約11万人以上※」が登録する、日本最大級の会員検索システム（データベース）をそのままご利用いただけます。※IBJ2026年公式発表より<br />
            多忙を極める男性医師の婚活において、最大の敵は「お見合いのミスマッチによる時間の浪費」です。<br />
            当相談所では、この広大なデータベースとあわせて、IBJのAIマッチング機能を活用しています。<br />
            過去の成婚データをもとにした分析により、お相手側の申し込み傾向を踏まえたご提案が可能です。<br />
            膨大な母数の中から、「最初からお互いにお見合いを受諾する確率が高い、相性の良い可能性が高いお相手を中心にご提案するため、闇雲に多くのお相手と会う必要がなくなります。
          </p>
        </section>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl  p-3 sm:p-8 shadow-sm space-y-3">
              ...
              <ul className="list-disc list-inside space-y-2 text-[20px]">
                ...
                <li><strong>解説:</strong> 医師の結婚、特に家系やクリニックの継承が絡む場合、当事者二人だけの合意では成立しません。「お相手の出身校や専門科」「実家の家柄」「将来の同居や開業への理解度」など、親族側が求める無言の条件が存在します。当相談所では、最初の戦略面談の時点で「ご実家の意向や将来の承諾ライン」をあらかじめヒアリング。親族からの祝福を得られるお相手選びの基準を初期段階から設定し、最後の段階で振り出しに戻るリスクを減らします</li>
              </ul>
            </div>
        ...
        <section className="bg-white rounded-3xl border-2 border-sky-300 p-4  shadow-sm space-y-6">
          ...
          <div className="bg-sky-50/80 p-6 sm:p-8 rounded-2xl border border-sky-200 space-y-4">
            ...
            <ul className="list-disc list-inside space-y-3 text-[20px] text-gray-800">
              ...
              <li>月1〜2回の定期戦略面談（対面・Zoom選択可）：進捗管理と翌月のアクションプラン策定</li>
              <li>お見合い調整・交際管理代行：スケジュール調整はすべて相談所にお任せ</li>
              <li>このほかに入会金・初期プロデュース登録料・成婚料がかかります。詳細は料金プランのページをご覧ください。</li>
            </ul>
        ...
        <section className="bg-white rounded-3xl border-2 border-sky-300 p-8 sm:p-10 shadow-sm space-y-6">
          ...
          <p className="text-[20px]">
            大阪梅田ドクターズ結婚相談所の最大の強みは、データに基づく冷静な「外からの戦術」と、医療現場の医師しか知り得ない「内からのリアル」の完璧な融合にあります。<br />
            医師同士の婚活（同職婚）において重要なのは、スペックの裏側にある「ライフスタイルの一致」です。<br />
            当相談所では、数々のハイスペック成婚を導いてきたベテラン仲人が、客観的なデータ分析と実家・両親対策のノウハウを駆使して、成婚への外堀を確実に埋めていきます。<br />
            さらに医療現場の最前線を熟知した現役の女性医師も伴走。多忙を極める勤務医の日常やオンコールの緊張感、医師のキャリアに対する本音や繊細な心理を理解した上で、LINEによる直接相談で2人の距離感についてアドバイスします。<br />
            無駄なすれ違いやプライドの衝突を未然に防ぎ、「短い期間での医師同士のスピード成婚」を目指せるのです。
          </p>
        </section>
        ...
        <section className="bg-gradient-to-br from-sky-950 via-slate-900 to-blue-950 text-white rounded-3xl p-8 sm:p-12 shadow-xl space-y-8 border border-sky-700/50">
          ...
          <p className="leading-relaxed text-white text-[20px]">
            ...
            当相談所には、数々のハイスペック成婚を導いてきた「百戦錬磨のベテラン仲人」と、医療現場の最前線を知り尽くした「現役の女性医師アドバイザー」、そして「提携大手の巨大インフラとAI」が揃っています。この3つの要素がシンクロするからこそ、この3つの要素がそろう環境で、「医師同士のスピード成婚」が実現します。<br />
            ベテラン仲人が培ってきた「成婚しやすいお相手の行動パターン」の客観的なデータ分析と、実家・両親対策の豊富なノウハウ。そこへ、現役女性医師による「ドクター特有の心理・ライフスタイル」という内側からの深い理解を掛け合わせます。<br />
            客観データによる冷徹なまでの具体戦術、同職だからこそ通じ合う深い心理理解、アンドAIによる超高確率なスクリーニング。このトリプルハイブリッド体制が、あなたの貴重な時間を無駄にすることなく、成婚を目指します
          </p>
        </section>
