        ...
        <section className="mt-10 rounded-2xl bg-white border border-pink-200 p-6 sm:p-8 shadow-sm">
          ...
          <div className="mt-6 text-[20px] leading-relaxed text-gray-700">
            ...
            <p>
              ...
              その後、街やマッチングアプリやSNSの出会いでは、年齢詐称、職業詐称、年収詐称などのリスクもあふれ、周りのリアルな話でも、付き合っていると思っていたら既婚者だった、年齢や本名はウソだった、会社も違ったという話は恋愛あるあるです。

              <br /><br />

              <span className="font-semibold text-pink-700">
                大阪梅田ドクターズ結婚相談所では、身元審査をクリアした人だけしかおらず、独身偽装や年収・経歴の詐称ができない仕組みになっています。
              </span>

              <br /><br />

              ハイスペック男女やご両親がしっかりされているご家族との関係が良好な男女は、「未来」のためにお金を払う経済力があるので、初期費用や月会費を「安全の保証と、時間効率のための必要経費」と捉えています。そのため経済的・精神的に自立した魅力的な男女が大阪梅田ドクターズ結婚相談所にたくさん集まるのです。

              <br /><br />

              <span className="font-medium text-gray-900">
                医師、医療関係者、経営者、公務員、弁護士、税理士などハイステータスの方々。
              </span>
