...
export default function HomePage() {
  ...
  const quizQuestions = {
    ...
    5: {
      ...
      answers: [
        { label: "A", text: "相手を否定せず、いつでも味方でいられる「安心感と誠実さ」" },
      ...
      <section className="max-w-5xl mx-auto py-16 px-4 sm:px-6 relative z-10">
        <div className="text-center mb-10">
          ...
          <h2 className="text-lg sm:text-2xl font-black text-gray-900 tracking-tight">
            現役女医監修×キャリア20年ベテランが仕掛ける「ベストを目指す婚活プロデュース」<br/>
            <span className="text-sm sm:text-base font-bold text-rose-500 mt-2 block">
              現役女医監修×キャリア20年ベテランが仕掛ける「他には少ない婚活」
            </span>
          </h2>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-md rounded-3xl p-6 sm:p-10 border border-white shadow-[0_15px_40px_rgba(230,162,179,0.03)] text-center max-w-4xl mx-auto">
          ...
          <p className="text-[13px] sm:text-sm text-gray-600 leading-xl font-medium text-justify max-w-3xl mx-auto">
            ...
            この、医療界と婚活界のトッププロ2名がタッグを組み、会員様1名に対して<span className="text-[#D9889D] font-black">「男女2人1組の専任チーム」</span>として密着サポートする、結婚相談所です。
          </p>
        </div>
      </section>
      ...
      <section className="max-w-5xl mx-auto py-12 px-4 sm:px-6 relative z-10">
        ...
        <div className="bg-white/90 backdrop-blur-md rounded-3xl p-6 sm:p-10 border border-white shadow-[0_20px_40px_rgba(0,0,0,0.02)] max-w-4xl mx-auto">
          <p className="text-[13px] sm:text-sm text-gray-600 leading-xl font-medium text-justify mb-8">
            大阪の結婚相談所［大阪梅田ドクターズ結婚相談所］の強みは、現役医師とカウンセラー歴20年のベテラン男性仲人が「2名1組のチーム」となり、あなた専用の婚活セカンドとして徹底的に伴走する点にあります。多くの大手結婚相談所やIBJ加盟店でありがちな「ただ条件を並べてシステムで検索するだけ」の機械的なマッチングでは、結婚後の価値観の不一致による失敗や、入会後のミスマッチによるスピード離婚のリスクを排除できません。<br/><br/>
            当相談所では、まずあなた自身が気づいていない深層心理にある「本当の結婚相手への理想像」を入会面談で徹底的に解剖します。医師監修のカウンセリング心理学や脳科学、行動経済学のアプローチを用いて、あなたが人生において「譲れない条件」と「実は妥協しても幸せになれるポイント」をロジカルに切り分けます。そこに、20年間関西圏のシビアな婚活市場（大阪市・堺市・東大阪市・枚方市・吹田市・豊中市・八尾市など）を見続けてきたプロの豊富な成婚データを掛け合わせることで、あなたのライフスタイルや性格に100%マッチする「隠れた優良男性・理想の女性」の条件を科学的に特定。高収入・高学歴・正社員・公務員・経営者など、身元が保証された年収600万円以上のハイクラスな会員層からも、あなたに本当に合うお相手をスクリーニングします。
          </p>
      ...
      <section className="max-w-5xl mx-auto py-12 px-4 sm:px-6 relative z-10">
        ...
        <div className="bg-white/90 backdrop-blur-md rounded-3xl p-6 sm:p-10 border border-white shadow-[0_20px_40px_rgba(0,0,0,0.02)] max-w-4xl mx-auto text-justify">
          <p className="text-[13px] sm:text-sm text-gray-600 leading-xl font-medium">
            婚活において「理想をあきらめたくない」というアラサー・アラフォー女性の切実な願いや、「自分の男のプライドを傷つけられたくない」「会社の同僚や友人にバレたくない」という20代・30代・40代のビジネスパーソンの男の本音を、私たちは決して否定しません。客観的なデータ分析（ロジカルな戦略）と、1対1の手厚いサポート（感情に寄り添う親身なケア）を完璧に両立させることができます。<br/><br/>
            ...
            恋愛経験なしの方や口下手な男性であっても、2名のプロがお見合い会話術の伝授から梅田・難波での服装コーディネート（ショッピング同行）、さらには交際中のLINEの返信頻度や、仮交際お断りの理由分析、真剣交際タイミングの調整、さらにはプロポーズの言葉・シチュエーションの演出までを完全バックアップ。自己流の婚活やマッチングアプリの不都合な真実（サクラ・嘘・ヤリモク）に振り回されて婚活疲れを起こす前に、ベストを目指すプロフェッショナルによる妥協なき「理想像の徹底解剖」をぜひご体感ください。あなたのプライドを守りながら、スピード成婚を目指すシステムがここにあります。
          </p>
        </div>
      </section>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-24">
      ...
      <div className="relative bg-[#F6F6FA] border border-[#E6E6F0] rounded-3xl p-8 shadow-2xs flex flex-col justify-between transition-all hover:shadow-md">
        <div>
          ...
          <div className="space-y-4 text-xs text-gray-600 leading-relaxed">
            <p>
              条件としての理想を並べるだけでなく、これからのあなたの人生や実際の生活を、本当に豊かにできるお相手を探すことが重要です。
            </p>
            <p>
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        <div className="lg:col-span-8 space-y-4">
          ...
          <h3 className="text-base sm:text-lg lg:text-xl font-bold leading-relaxed text-gray-100 pt-2">
            そう願うあなたのために、私たちは持てるすべての人脈と英知を尽くして並走します。<br className="hidden lg:block" />
