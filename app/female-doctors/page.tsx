      ...
      <div className="mx-auto max-w-4xl space-y-12">
        ...
        <section className="bg-white rounded-3xl border-2 border-rose-200 p-8 sm:p-10 shadow-sm space-y-6">
          ...
          <p className="text-[20px] space-y-4">
            ...
            この広大なデータベースに対して最先端のAIマッチングを掛け合わせ、過去の成婚データから「あなたのような知性あふれる女性医師を、生涯の伴侶として心から望んでいるハイスペック男性（男性医師、経営者、大手企業幹部など）」をピンポイントでスクリーニング。受諾確率の高いお相手だけを厳選するため、効率重視の婚活が可能です。
          </p>
        </section>
