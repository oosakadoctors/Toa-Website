...
export default function BeginnerLandingPage() {
  return (
    <div className="min-h-screen bg-emerald-50/60 text-slate-800 font-sans antialiased selection:bg-emerald-200 w-full overflow-x-hidden">
      ...
      <header className="relative bg-gradient-to-br from-emerald-200 via-teal-100 to-emerald-300 text-slate-900 py-14 px-4 md:px-6 text-center overflow-hidden w-full border-b border-emerald-300/80 shadow-xs">
        <div className="max-w-5xl mx-auto relative z-10 w-full">
          ...
          <div className="bg-white/95 p-6 rounded-2xl border border-emerald-300 shadow-sm inline-block text-left w-full backdrop-blur-sm">
            <p className="text-emerald-900 font-bold text-lg md:text-xl mb-2 text-center">「誰を選べばいいかわからない」「どんなライフスタイルがいいかわからない」</p>
      ...
      <section className="py-8 w-full">
        <div className="max-w-5xl mx-auto w-full">
          <div className="bg-white md:rounded-2xl p-5 md:p-8 shadow-sm border-y md:border border-emerald-200 space-y-6 w-full">
            ...
            <div className="grid gap-2 md:gap-3 w-full">
              {[
                ...
                <div key={idx} className="flex items-start gap-3 bg-emerald-50 p-4 border border-emerald-200/80 w-full md:rounded-xl">
                  <span className="text-emerald-600 font-bold shrink-0 text-lg">✅</span>
                  <p className="text-base text-slate-800 font-semibold leading-relaxed w-full">{text}</p>
                </div>
              ))}
            </div>

            <div className="px-4 text-center pt-2 w-full">
              <p className="text-emerald-900 font-bold text-lg w-full">
      ...
      <section className="py-8 bg-emerald-100/60 w-full border-y border-emerald-200">
        <div className="max-w-5xl mx-auto w-full space-y-6">
          <div className="bg-white p-5 md:p-6 border border-emerald-200 w-full space-y-3 md:rounded-2xl shadow-xs">
            ...
            <p className="text-base leading-relaxed text-slate-700 w-full">
              ...
              あなたがこれまで恋愛や婚活で思うようにいかなかったのは、テクニック不足だけではありません。あなたの心の中にある、<span className="bg-emerald-200/80 text-emerald-950 px-2 py-0.5 rounded font-bold">4つの「マインドのすれ違い」</span>が原因かもしれません。
            </p>
          </div>
          ...
          <div className="grid gap-3 md:gap-4 md:grid-cols-2 w-full">
            <div className="bg-white p-5 border border-emerald-200 flex flex-col justify-between w-full md:rounded-xl shadow-xs">
            ...
            <div className="bg-white p-5 border border-emerald-200 flex flex-col justify-between w-full md:rounded-xl shadow-xs">
              <div className="w-full">
                <h4 className="font-bold text-emerald-800 text-base mb-2 w-full">② 自分の「魅力が何か」がわからない</h4>
                <p className="text-base text-slate-700 leading-relaxed w-full">
            ...
            <div className="bg-white p-5 border border-emerald-200 flex flex-col justify-between w-full md:rounded-xl shadow-xs">
              <div className="w-full">
                <h4 className="font-bold text-emerald-800 text-base mb-2 w-full">③ 異性の視点を意識する機会がなかった</h4>
                <p className="text-base text-slate-700 leading-relaxed w-full">
  ...
  <Link 
  href="EQ" 
  className="mt-4 inline-flex items-center justify-center gap-2 rounded-xl bg-emerald-700 hover:bg-emerald-800 text-emerald-50 px-5 py-2.5 text-sm font-bold shadow-xs hover:shadow-md transition-all duration-200 active:scale-[0.98]"
>
  ...
  <ArrowRight className="w-4 h-4" />
            ...
            <div className="bg-white p-5 border border-emerald-200 flex flex-col justify-between w-full md:rounded-xl shadow-xs">
              <div className="w-full">
                <h4 className="font-bold text-emerald-800 text-base mb-2 w-full">④ 「選ぶ・選ばれる」という立場への覚悟</h4>
                <p className="text-base text-slate-700 leading-relaxed w-full">
      ...
      <section className="py-8 w-full">
        <div className="max-w-5xl mx-auto w-full">
          <div className="bg-white md:rounded-2xl p-0 md:p-8 shadow-sm border-y md:border border-emerald-200 space-y-6 w-full">
            ...
            <div className="grid gap-2 md:gap-4 md:grid-cols-2 w-full">
              <div className="bg-emerald-50 p-5 border border-emerald-200 w-full md:rounded-xl">
            ...
            <div className="text-center px-4 pt-2">
              <a
                href="#eq-check"
                className="inline-flex items-center gap-2 rounded-full bg-emerald-600 hover:bg-emerald-700 px-7 py-3.5 text-base font-bold text-white shadow-md transition-all hover:shadow-lg"
              >
                🌿 EQ診断をしてみる
                <span>→</span>
              </a>
            ...
            <div className="bg-gradient-to-br from-emerald-100/70 via-teal-50 to-emerald-100/40 p-5 md:p-7 border border-emerald-200/90 w-full md:rounded-2xl space-y-4 shadow-2xs">
              <div className="flex items-center gap-3 w-full">
                ...
                <h4 className="font-bold text-emerald-950 text-lg md:text-xl tracking-wide w-full">
                  💚 ベテランカウンセラーからのメッセージ 💚
                </h4>
              </div>
              <p className="font-bold text-emerald-900 text-base md:text-lg tracking-wide w-full">
                あなたの心に「24時間」寄り添います
              </p>
      ...
      <section id="support" className="py-8 bg-white w-full">
        <div className="max-w-5xl mx-auto w-full">
          ...
          <div className="space-y-6 relative before:absolute before:inset-0 before:left-6 md:before:left-1/2 before:w-0.5 before:bg-emerald-300 w-full">
            
            {/* アプローチ 1 */}
            <div className="relative flex flex-col md:flex-row md:justify-between items-start md:items-center w-full">
              <div className="absolute left-4 md:left-1/2 transform md:-translate-x-1/2 w-10 h-10 rounded-full bg-emerald-600 text-white font-extrabold flex items-center justify-center border-4 border-white shadow-xs z-10 text-base">
                1
              </div>
              <div className="pl-14 w-full md:pl-0 md:w-[46%] bg-emerald-50/70 p-5 border border-emerald-200 md:rounded-xl">
          ...
          <div className="mt-8 p-5 bg-emerald-100/50 border border-emerald-200 text-center w-full md:rounded-xl">
            <h4 className="font-bold text-slate-900 text-lg mb-2 px-4 w-full">── 主役は、どこまでも「あなた」です</h4>
            <p className="text-base text-slate-700 leading-relaxed px-4 w-full">
      ...
      {/* サポート体制 */}
      <section className="py-8 bg-emerald-100/60 text-slate-800 w-full border-y border-emerald-200">
        <div className="max-w-5xl mx-auto w-full space-y-6">
          <div className="bg-white border border-emerald-200 w-full overflow-hidden md:rounded-2xl shadow-xs">
            <div className="p-5 md:p-6 space-y-4 w-full">
              <h4 className="font-bold text-emerald-950 text-lg md:text-xl tracking-wide text-center w-full">
                あなたの「初めて」を私たちが100%バックアップします
              </h4>
              <div className="grid gap-2 md:grid-cols-3 md:gap-4 w-full">
                <div className="bg-emerald-50/80 p-4 border border-emerald-200/60 rounded-xl">
                  <p className="font-bold text-emerald-800 text-base mb-1">1. 素直なあなたとじっくり相談</p>
                  <p className="text-base text-slate-700 leading-relaxed">異性との接し方の基本やデートのマナーを、イチから丁寧にお伝えします。</p>
                </div>
                <div className="bg-emerald-50/80 p-4 border border-emerald-200/60 rounded-xl">
                  <p className="font-bold text-emerald-800 text-base mb-1">2. 清楚さを愛してくれる人をご紹介</p>
                  <p className="text-base text-slate-700 leading-relaxed">あなたのピュアさを何よりの魅力だと感じてくれる誠実な会員様をピックアップ。</p>
                </div>
                <div className="bg-emerald-50/80 p-4 border border-emerald-200/60 rounded-xl">
                  <p className="font-bold text-emerald-800 text-base mb-1">3. お見合い・交際もサポート</p>
                  <p className="text-base text-slate-700 leading-relaxed">服装選びからLINEの返し方、デートのお店まで、一緒に考えていきましょう。</p>
                </div>
              </div>
              <p className="text-center text-emerald-900 font-bold text-base leading-relaxed pt-2 px-4 w-full">
      ...
      <section className="py-8 w-full">
        <div className="max-w-5xl mx-auto w-full space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-2 w-full">
            {/* 男性の相談例 */}
            <div className="bg-white p-5 border border-emerald-200 md:rounded-2xl shadow-2xs space-y-4 w-full">
              <h3 className="font-bold text-emerald-950 text-lg border-b border-emerald-100 pb-2 w-full">👨 男性のリアルな相談例</h3>
              <div className="space-y-3">
                <div className="bg-emerald-50 p-4 rounded-xl border-l-4 border-emerald-500 w-full">
                  <p className="text-xs text-emerald-800 font-bold mb-1">相談者（20代後半・男性）</p>
                  <p className="text-base text-slate-700 leading-relaxed">「人生で一度も女性と付き合ったことがありません。お見合いの席で、過去の恋愛経験を聞かれたら正直に答えるべきですか？」</p>
                </div>
                <div className="bg-emerald-50 p-4 rounded-xl border-l-4 border-emerald-500 w-full">
                  <p className="text-xs text-emerald-800 font-bold mb-1">相談者（30代半ば・男性）</p>
                  <p className="text-base text-slate-700 leading-relaxed">「服に全く興味がなく、普段着しか持っていません。お店に一緒に行って選んでもらうのは、入会前でも相談できますか？」</p>
                </div>
              </div>
            </div>
            ...
            {/* 女性の相談例 */}
            <div className="bg-white p-5 border border-emerald-200 md:rounded-2xl shadow-2xs space-y-4 w-full">
              <h3 className="font-bold text-teal-950 text-lg border-b border-emerald-100 pb-2 w-full">👩 女性のリアルな相談例</h3>
              <div className="space-y-3">
                <div className="bg-emerald-50 p-4 rounded-xl border-l-4 border-teal-500 w-full">
                  <p className="text-xs text-teal-800 font-bold mb-1">相談者（30代前半・女性）</p>
                  <p className="text-base text-slate-700 leading-relaxed">「仕事はバリバリこなせるのに、恋愛になると途端に甘え方がわからなくなります。いい人はみつかりますか？」</p>
                </div>
                <div className="bg-emerald-50 p-4 rounded-xl border-l-4 border-teal-500 w-full">
                  <p className="text-xs text-teal-800 font-bold mb-1">相談者（20代後半・女性）</p>
                  <p className="text-base text-slate-700 leading-relaxed">「周りが結婚していく焦りで婚活を始めましたが、自分がどんな人を好きなのか、どんな結婚生活を送りたいのか本当にわかりません」</p>
                </div>
                <div className="bg-emerald-50 p-4 rounded-xl border-l-4 border-teal-500 w-full">
                  <p className="text-xs text-teal-800 font-bold mb-1">相談者（30代前半・女性）</p>
                  <p className="text-base text-slate-700 leading-relaxed">「恋愛経験がないことを隠したくて、アプリで無理して『慣れてる風』を装ってました。ありのままの自分で婚活をリスタートしたいです」</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* 3つの小さなお約束 */}
          <div className="bg-emerald-100/70 p-5 border border-emerald-200 md:rounded-2xl w-full space-y-4">
            <h3 className="font-bold text-emerald-950 text-lg flex items-center gap-2 w-full">
              <ShieldCheck className="w-5 h-5 text-emerald-700 shrink-0" />
              🛡️ 私たちからの3つの小さなお約束
            </h3>
            <p className="text-base text-slate-800 font-medium w-full leading-relaxed">
      ...
      <section id="line-add" className="py-12 bg-gradient-to-br from-emerald-200 via-teal-100 to-emerald-300 text-slate-900 text-center px-4 w-full border-t border-emerald-300">
        <div className="max-w-5xl mx-auto space-y-4 w-full">
          ...
          <p className="text-slate-700 text-base font-medium leading-relaxed tracking-wide w-full">
          ...
          <div className="pt-4 flex justify-center w-full">
            <a href="#line-add" className="inline-flex items-center justify-center gap-2 bg-emerald-700 hover:bg-emerald-800 text-white font-extrabold px-8 py-4 rounded-full shadow-md hover:shadow-lg transition duration-200 tracking-wider text-base w-full sm:w-auto">
